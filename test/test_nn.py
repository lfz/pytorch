...
new_module_tests = [
    ...
    dict(
        fullname='Fold2d_int_input',
        constructor=lambda: nn.Fold((3, 3), 2, 1, 0, 1),
        input_size=(2, 16, 4),
        check_gradgrad=False,
        test_cuda=True,
    ),
    ...
    dict(
        fullname='Unfold3d',
        constructor=lambda: nn.Unfold((2, 2, 2), (1, 1, 1), (0, 0, 0), (1, 1, 1)),
        input_size=(2, 4, 3, 3, 3),
        check_gradgrad=False,
        test_cuda=True,
    ),
    dict(
        fullname='Fold3d',
        constructor=lambda: nn.Fold((3, 3, 3), (2, 2, 2), (1, 1, 1), (0, 0, 0), (1, 1, 1)),
        input_size=(2, 16, 8),
        check_gradgrad=False,
        test_cuda=True,
    ),
    dict(
        fullname='Unfold3d_int_input',
        constructor=lambda: nn.Unfold(2, 1, 0, 1),
        input_size=(2, 4, 3, 3, 3),
        check_gradgrad=False,
        test_cuda=True,
    ...
    dict(
        fullname='Fold3d_int_input',
        constructor=lambda: nn.Fold((3, 3, 3), 2, 1, 0, 1),
        input_size=(2, 16, 8),
        check_gradgrad=False,
        test_cuda=True,
    ),
