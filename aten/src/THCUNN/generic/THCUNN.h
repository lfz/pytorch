...
THC_API void THNN_(Col2Row_updateOutput)(
                  THCState *state,
                  THCTensor *input,
                  THCTensor *output,
                  int outputWidth,
 ...
 THC_API void THNN_(Col2Row_updateGradInput)(
                  THCState *state,
                  THCTensor *gradOutput,
                  THCTensor *gradInput,
                  int kW,
...
THC_API void THNN_(Col2Vol_updateOutput)(
                  THCState *state,
                  THCTensor *input,
                  THCTensor *output,
 ...
 THC_API void THNN_(Col2Vol_updateGradInput)(
                  THCState *state,
                  THCTensor *gradOutput,
                  THCTensor *gradInput,
                  int kT, int kH, int kW,
